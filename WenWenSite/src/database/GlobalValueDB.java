...
public class GlobalValueDB {
	...
	private final String CAN_INSERT_TEMPLATE_DATA = "建立假資料";
	...
	private final String ORACLE_CREATE_TABLE = "create table " + DATABASE_TEMP + "." + TABLE_TEMP + "(" + TABLE01_COLUMN + ")";
	...
	public String getCAN_INSERT_TEMPLATE_DATA() {
		return CAN_INSERT_TEMPLATE_DATA;
	}
